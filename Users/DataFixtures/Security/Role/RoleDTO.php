...
namespace App\Module\Users\Groups\Users\DataFixtures\Security\Role;

use App\Module\Users\Groups\Users\DataFixtures\Security\Role;
...
final class RoleDTO implements RoleEventInterface
{
    ...
    public function getTranslate() : ArrayCollection
    {
        ...
        foreach(Locale::diffLocale($this->translate) as $locale)
        {
            ...
            $TransFormDTO = new \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Trans\RoleTransDTO();
    ...
    /**
     * @param \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Trans\RoleTransDTO $translate
     */
    public function addTranslate(\App\Module\Users\Groups\Users\DataFixtures\Security\Role\Trans\RoleTransDTO $translate) : void
    {
    ...
    public function getVoter() : ArrayCollection
    {
        ...
        {
            foreach(\App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\RoleVoterDTO::VOTERS as $prefix => $voter)
            {
                $RoleVoterDTO = new \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\RoleVoterDTO();
    ...
    public function addVoter(\App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\RoleVoterDTO $voter) : void
    {
