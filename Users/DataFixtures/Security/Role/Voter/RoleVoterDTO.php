...
namespace App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter;
...
final class RoleVoterDTO implements RoleVoterInterface
{
    ...
    public function getTranslate() : ArrayCollection
    {
        ...
        {
            $TransFormDTO = new \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\Trans\VoterTransDTO();
    ...
    public function addTranslate(\App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\Trans\VoterTransDTO $translate) : void
    {
        $this->translate->add($translate);
    }
    
    /** Метод для инициализации и маппинга сущности на DTO в коллекции  */
    public function getTranslateClass() : \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\Trans\VoterTransDTO
    {
        return new \App\Module\Users\Groups\Users\DataFixtures\Security\Role\Voter\Trans\VoterTransDTO();
    }
